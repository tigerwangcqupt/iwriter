...
public class CodeAPIImpl implements CodeAPI {
     ...
     */
    @Override
    public PageList<CodeModel> list(CodeModelDto dto) throws YyrzPcException {
     ...
     */
    @Override
    public IDResponse addType(IDRequest request) throws YyrzPcException {
        ...
        try {
            ...
            throw new YyrzPcException(ExceptionEnum.SysException.getCode(),
